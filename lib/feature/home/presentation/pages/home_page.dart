...
class _HomePageState extends State<HomePage>
      ...
      Future.delayed(const Duration(milliseconds: 1000), () {
        if (mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(context.l10n.snackScanSuccessful)),
          );
        }
      });
    });
  ...
  void _navigateToAlertDetails(Alert alert) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(context.l10n.snackShowDetailsFor(alert.assetName))),
    );
  }

  void _navigateToAllAlertsPage() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text(context.l10n.snackNavigatingToAllAlerts)),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final overviewCardDataListLight = [
      OverviewCardData(
          title: l10n.overviewTotalAssets,
          value: '10,245',
          icon: Icons.inventory_2_outlined,
          color: const Color(0xFF42A5F5)),
      OverviewCardData(
          title: l10n.overviewActive,
          value: '9,876',
          icon: Icons.check_circle_outline,
          color: const Color(0xFF66BB6A)),
      OverviewCardData(
          title: l10n.overviewMissing,
          value: '112',
          icon: Icons.warning_amber_rounded,
          color: const Color(0xFFEF5350)),
    ];

    final overviewCardDataListDark = [
      OverviewCardData(
          title: l10n.overviewTotalAssets,
          value: '10,245',
          icon: Icons.inventory_2_outlined,
    ...
    final actionButtonDataList = [
      ActionButtonData(
        icon: Icons.nfc_rounded,
        label: l10n.actionScanRfid,
    ...
    final allAlerts = [
      ...
      Alert(
          ...
          issue: l10n.alertIssueOutOfRange,
    ...
    isDarkMode ? overviewCardDataListDark : overviewCardDataListLight;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children:
                      List.generate(actionButtonDataList.length, (index) {
                        return _ActionButton(
                          data: actionButtonDataList[index],
                          index: index,
                          isDarkMode: isDarkMode,
                        );
                      }),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    if (allAlerts.length > topAlerts.length &&
                      ...
                      TextButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              l10n.homeViewAll(allAlerts.length),
                              style: GoogleFonts.poppins(
                                fontSize: 12.sp,
                                fontWeight: FontWeight.w600,
