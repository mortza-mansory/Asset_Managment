...
class NewCustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final defaultBackgroundColor =
        isDarkMode ? primaryAppColor.withOpacity(0.9) : primaryAppColor;
    final defaultTextColor =
        (backgroundColor ?? defaultBackgroundColor).computeLuminance() > 0.5
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          disabledBackgroundColor:
              (backgroundColor ?? defaultBackgroundColor).withOpacity(0.7),
          overlayColor: isDarkMode ? Colors.white12 : Colors.black12,
