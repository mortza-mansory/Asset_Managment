...
class _SearchPageState extends State<SearchPage> {
  ...
  static final List<SearchResultItem> _allSearchableItems = [
    SearchResultItem(
        ...
        type: 'تجهیزات الکترونیکی',
        iconData: Icons.laptop_mac_outlined,
        description:
            'لپ‌تاپ قدرتمند برای کارهای گرافیکی و پردازشی، موجود در انبار مرکزی.',
        lastModified: DateTime.now().subtract(const Duration(days: 5)),
        itemColor: Colors.blueAccent.shade400,
        details: {
          'پردازنده': 'Core i9 13th Gen',
          'رم': '32GB DDR5',
          'حافظه': '1TB NVMe SSD',
          'کد اموال': 'LP-00125',
          'وضعیت': 'فعال'
    ...
    SearchResultItem(
        ...
        description:
            'قرارداد سالانه با شرکت توسعه‌دهنده نرم‌افزار مدیریت ارتباط با مشتری.',
        lastModified: DateTime.now().subtract(const Duration(days: 22)),
        itemColor: Colors.green.shade600,
        details: {
          'شماره قرارداد': 'CRM-SUP-2024',
          'طرف قرارداد': 'شرکت راهکاران پویا',
          'تاریخ انقضا': '1404/08/15',
          'مبلغ': '۲۵۰،۰۰۰،۰۰۰ ریال'
        }),
    SearchResultItem(
        id: 'srch-003',
        ...
        description: 'دوربین IP با قابلیت دید در شب، پوشش کامل پارکینگ شمالی.',
        lastModified: DateTime.now().subtract(const Duration(hours: 72)),
        itemColor: Colors.redAccent.shade400,
        details: {
          'مدل': 'Hikvision DS-2CD2T47G2',
          'رزولوشن': '4MP',
          'وضعیت ضبط': '24/7',
          'آخرین سرویس': '1403/02/10'
        }),
    SearchResultItem(
        id: 'srch-004',
        name: 'پرینتر چندکاره HP OfficeJet Pro',
        type: 'ماشین‌های اداری',
        iconData: Icons.print_outlined,
        description:
            'پرینتر رنگی با قابلیت اسکن، کپی و فکس، طبقه دوم، اتاق حسابداری.',
        lastModified: DateTime.now().subtract(const Duration(days: 15)),
        itemColor: Colors.cyanAccent.shade700,
        details: {
          'مدل': 'HP OfficeJet Pro 9010',
          'نوع جوهر': 'رنگی',
          'اتصال': 'Wi-Fi, Ethernet',
          'کد بخش': 'ACC-PRN-02'
        }),
    SearchResultItem(
        id: 'srch-005',
        name: 'گزارش عملکرد فروش - سه ماهه اول',
        type: 'گزارشات مدیریتی',
        iconData: Icons.assessment_outlined,
        description:
            'تحلیل جامع عملکرد تیم فروش و مقایسه با اهداف تعیین‌شده برای Q1.',
        lastModified: DateTime.now().subtract(const Duration(days: 60)),
        itemColor: Colors.orange.shade700,
        details: {
          'تهیه‌کننده': 'واحد فروش',
          'دوره زمانی': 'Q1-1403',
          'شاخص کلیدی': 'رشد 15% نسبت به دوره مشابه سال قبل'
        }),
    SearchResultItem(
        id: 'srch-006',
        ...
        description:
            'سرور اصلی برای بک‌آپ‌گیری روزانه از داده‌های حیاتی سازمان.',
        lastModified: DateTime.now().subtract(const Duration(days: 2)),
        itemColor: Colors.indigo.shade400,
        details: {
          'پردازنده': 'Dual Intel Xeon Gold',
          'رم': '128GB ECC',
          'فضای ذخیره‌سازی': '48TB RAID 6',
    ...
    SearchResultItem(
        ...
        description:
            'مانیتور ۲۷ اینچ خمیده با نرخ بروزرسانی بالا، مورد استفاده تیم طراحی.',
        lastModified: DateTime.now().subtract(const Duration(days: 90)),
        itemColor: Colors.tealAccent.shade400,
        details: {
          'اندازه': '27 اینچ',
          'رزولوشن': 'QHD (2560x1440)',
          'نرخ بروزرسانی': '240Hz',
          'کد کاربر': 'DES-EMP-017'
        }),
    SearchResultItem(
        id: 'srch-008',
        ...
        description:
            'راهنمای کامل کار با دستگاه اسپکترومتر و میکروسکوپ الکترونی.',
        lastModified: DateTime.now().subtract(const Duration(days: 120)),
        itemColor: Colors.brown.shade400,
        details: {
          'بخش': 'آزمایشگاه تحقیق و توسعه',
          'نسخه': '3.1',
          'آخرین بازبینی': '1402/11/05'
        }),
    SearchResultItem(
        id: 'srch-009',
        ...
        description:
            'فاکتور مربوط به خرید سوئیچ‌ها و روترهای سیسکو برای ارتقاء زیرساخت.',
        lastModified: DateTime.now().subtract(const Duration(days: 45)),
        itemColor: Colors.lime.shade800,
        details: {
          'شماره فاکتور': 'INV-NET-2024-0078',
          'تامین‌کننده': 'شرکت ارتباطات امن',
          'مبلغ کل': '۸۷۰،۰۰۰،۰۰۰ ریال'
        }),
    SearchResultItem(
        id: 'srch-010',
        name: 'پروژکتور سالن کنفرانس اصلی',
        type: 'تجهیزات سمعی و بصری',
        iconData: Icons.settings_brightness_outlined,
        description:
            'پروژکتور Epson با روشنایی بالا، مناسب برای ارائه‌های بزرگ.',
        lastModified: DateTime.now().subtract(const Duration(days: 300)),
        itemColor: Colors.purpleAccent.shade200,
        details: {
          'مدل': 'Epson EB-L630U',
          'روشنایی': '6000 Lumens',
          'وضعیت لامپ': '65% عمر باقیمانده',
          'آخرین بروزرسانی نرم‌افزار': 'ندارد'
        }),
  ];
    ...
    if (!_searchPerformed && _searchText.isEmpty) {
      return Center(
        child: Padding(
          ...
          .scale(begin: const Offset(1.0, 1), curve: Curves.easeOut);
    }
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _SearchResultItemCard(
          ...
          onTap: () =>
              _showItemDetailsDialog(context, item), // پاس دادن callback
        )
...
class _SearchResultItemCard extends StatelessWidget {
  ...
  final VoidCallback onTap; // اضافه کردن callback
  ...
  const _SearchResultItemCard({
    ...
    required this.onTap, // Callback // الزامی
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final cardBackgroundColor =
        isDarkMode ? const Color(0xFF2C2D2D30) : Colors.white;
    ...
    return Card(
      ...
      child: InkWell(
        onTap: onTap, // استفاده از callback
        borderRadius: BorderRadius.circular(12.0),
              ...
              RichText(
                text: TextSpan(
                    style: GoogleFonts.poppins(
                        ...
                        height: 1.4),
                    children:
                        _buildHighlightedText(item.description, searchText)),
              ),
              SizedBox(width: 1.w),
